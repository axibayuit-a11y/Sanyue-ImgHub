                    ...
                    <template v-slot="props">
                        <div style="margin: 8px;">
                            ...
                            <el-table :data="props.row.data" style="width: 100%" :default-sort="{ prop: 'metadata.TimeStamp', order: 'descending' }" table-layout="fixed" :max-height="400">
                                <el-table-column prop="metadata.FileName" :label="$t('customerConfig.fileName')"></el-table-column>
                                ...
                                <el-table-column 
                                    ...
                                    :label="$t('customerConfig.uploadTime')" 
                ...
                <el-table-column :label="$t('customerConfig.allowUpload')">
                    <template v-slot="{ row }">
                        <el-switch
                            ...
                            :inactive-text="$t('customerConfig.forbid')"
